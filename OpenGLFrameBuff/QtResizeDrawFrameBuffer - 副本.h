...
protected:
	void drawFrame();
protected:
	//void GenerateTextImageTex2DArray();
...
protected:
	...
	//GLuint m_downloadPboId;
	//vmath::mat4 m_roateMat;
	...
	GLuint m_VBO_DrawText;
	GLuint m_EBO_DrawText;

	//QOpenGLTexture* m_TextTex2DArray = NULL;
	//bool m_bInitTextTex2DArray = true;
	//std::vector<vmath::vec4>m_textTexCoordVec;
	...
	//创建离屏渲染
	QOpenGLContext* m_sharedContext = NULL;
	QOffscreenSurface* m_offscreenSurface = NULL;

	std::shared_ptr<std::thread>m_offscreenRenderThread;

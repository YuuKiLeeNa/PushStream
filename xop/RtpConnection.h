...
#include "rtp.h"
#include "media.h"
//#include "net/Socket1.h"
//#include "net/TcpConnection.h"
#include "ZLToolKit/Network/TcpClient.h"
#include "ZLToolKit/Network/Socket.h"
...
{
public:
    RtpConnection(std::weak_ptr</*TcpConnection*/toolkit::TcpClient> rtsp_connection);
    ...
    toolkit::Socket::Ptr GetRtpSocket(MediaChannelId channel_id) const
    {
        return rtpfd_[channel_id];
    }
    //SOCKET GetRtcpSocket(MediaChannelId channel_id) const
    //{ return rtcpfd_[channel_id]; }
    toolkit::Socket::Ptr GetRtcpSocket(MediaChannelId channel_id) const
    {
        return rtcpfd_[channel_id];
    }
...
private:
	...
	std::weak_ptr</*TcpConnection*/toolkit::TcpClient> rtsp_connection_;
    std::string rtsp_ip_;
    uint16_t rtsp_port_;
    ...
    toolkit::Socket::Ptr rtpfd_[MAX_MEDIA_CHANNEL];
    toolkit::Socket::Ptr rtcpfd_[MAX_MEDIA_CHANNEL];
